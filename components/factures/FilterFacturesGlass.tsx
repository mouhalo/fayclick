/**
 * Composant de filtres glassmorphism pour les factures
...
interface FilterFacturesGlassProps {
  onFiltersChange: (filtres: FiltresFactures) => void;
  totalFactures: number;
  facturesFiltrees: number;
}

export function FilterFacturesGlass({ onFiltersChange, totalFactures, facturesFiltrees }: FilterFacturesGlassProps) {
  // États des filtres
